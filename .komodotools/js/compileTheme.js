...
var themeDirectory = process.argv[2];
var fs = require('fs');	// file system access
path = require('path');	// get directory from file name
var less = require('../util/less');	// less processor
...
var allFiles = [].concat(
		fs.readdirSync('../'+themeDirectory),
		fs.readdirSync('../'+themeDirectory+"/form").map(function(fname){ return "form/"+fname; }),
		fs.readdirSync('../'+themeDirectory+"/layout").map(function(fname){ return "layout/"+fname; })
	),
